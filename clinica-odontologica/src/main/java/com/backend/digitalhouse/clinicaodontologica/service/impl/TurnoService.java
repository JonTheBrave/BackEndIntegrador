...
public class TurnoService implements ITurnoService {
    ...
    public TurnoSalidaDto registrarTurno(TurnoEntradaDto turnoEntradaDto) throws BadRequestException {
        //Turno turnoRecibido = dtoEntradaAentidad(turnoEntradaDto);
    ...
    @Override
    public List<TurnoSalidaDto> listarTurnos() { //Este método es igual a el de PacienteService. Tenemos que mapear las dos situaciones.
